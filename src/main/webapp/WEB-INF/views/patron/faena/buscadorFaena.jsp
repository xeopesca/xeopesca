...
<div id="ReportDetails">
	<h2>
		<fmt:message key="patron.buscadorFaena.title" />
	</h2>

	<form:form action="/xeopesca/patron/buscadorFaena" method="POST"
		commandName="faena">
		...
		<table>
			...
			<tr>
				...
				<td><form:select path="estadoMar" id="idmar">
				...
				<td><form:select path="estadoCeo" id="idceo">
						<form:option value="" label="Todos" />
			...
			<tr>
				...
				<td><form:select path="direccionVento" id="idvento">
						<form:option value="" label="Todas" />
						<form:options items="${dirvento}" itemValue="id"
							itemLabel="literal" />
					</form:select></td>
			</tr>
			...
			<tr>
				...
				<td><input type="submit"
					value='<fmt:message key="patron.buscadorFaena.button.buscar"/>' /></td>
...
<c:if test="${!empty resultado}">
	...
	<div id="ReportDetails">
		...
		<script>
			...
			function onFeatureSelect(feature) {
				...
				popup = new OpenLayers.Popup.FramedCloud(
						...
						"<div style='font-size:.8em'>"
								+ i18n_msg.faena+": <a href='"+"editarFaena/"+feature.attributes.id+"'>"
								+ feature.attributes.id
								+ "</a>"
								+ "<br>"+i18n_msg.lance+": <a href='"+"novoLance/"+feature.attributes.id+"'>"
								+ feature.attributes.idlance + "</a>" +
			...
			var bounds = new OpenLayers.Bounds(308780.2375, 4472890.525,
					833068.2375, 4997178.525);
			var initialbbox = new OpenLayers.Bounds(398396.573996919,
					4606383.09616855, 743451.90103171, 4863685.95423634);
			var maxRes = 1024;
			var lat = 5302009.63;
			var lon = -1160006.63;
		...
		<table>
			...
			<c:forEach var="faenas" items="${resultado}" varStatus="status">
				...
				<tr class="ReportDetailsEvenDataRow">
					...
					<td class="ReportTableValueCell"><fmt:formatDate type="Date"
							pattern="yyyy-MM-dd" value="${faenas.data_inicio}" /></td>
					...
					<td class="ReportTableValueCell">
						<center>
							<a href="editarFaena/${faenas.id}"> <img
								src="/images/detalle.gif" />
							</a>
						</center>
					</td>
					...
					<td class="ReportTableValueCell">
						<center>
							<a href="deleteFaena/${faenas.id}"> <img
								src="/images/papelera.gif" /></a>
						</center>
					</td>
				</tr>
