		...
		<script>
			 OpenLayers.Control.Click = OpenLayers.Class(OpenLayers.Control, {
				...
				trigger : function(e) {
					...
					var avisoErro = document.getElementById("aviso");//mostra erro de navigator.geolocation.getCurrentPosition
					...
					if (navigator.geolocation){
						navigator.geolocation.getCurrentPosition(function(position) {
	            			...
	            			markers.addMarker(new OpenLayers.Marker(lonLat)); },showError);
					}else{avisoErro.innerHTML = "Geolocation is not supported by this browser.";}
